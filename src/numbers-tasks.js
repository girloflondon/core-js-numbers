...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  /* The formula(?) alpha = acos[(x1 x2 + y1 y2)/sqrt{(x1^2 + y1^2)(x2^2 + y2^2)} 
  Or θ = sin-1 [ |a × b| / (|a| |b|) ] */
  /* throw new Error('Not implemented'); */
}
...
function getLastDigit(value) {
  ...
  if (value >= 0 && Number.isInteger(value) === true) {
    ...
    x = 'The number must be integer and bigger or equal to 0';
  }
  return x;
  /* throw new Error('Not implemented'); */
}
...
// DON't FORGET TO SOLVE THIS ONE!!!
/**
